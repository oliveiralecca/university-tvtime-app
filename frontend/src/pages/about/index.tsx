      ...
      <div className="members">
        <button>
          <a href="https://github.com/oliveiralecca" target="_blank">
            <img
              src="https://avatars.githubusercontent.com/u/65191407?v=4"
              alt=""
            />
            <p>
              Letícia Oliveira
        ...
        <button>
          <a href="https://github.com/mpaullos" target="_blank">
            <img
              src="https://avatars.githubusercontent.com/u/82289818?v=4"
              alt=""
            />
            <p>
              Marcos Paulo <br />
        ...
        <button>
          <a href="https://github.com/rodrigodesan" target="_blank">
            <img
              src="https://avatars.githubusercontent.com/u/76262266?v=4"
              alt=""
            />
            <p>
              Rodrigo Nunes <br />
